                                 ...
                                 <tbody>
								    ...
								    while($row=mysqli_fetch_assoc($res)){?>
                                     <tr>
									    ...
									    <?php 
										if( $row['status']==1){
											echo "<span class='badge badge-complete'><a 
											href='?type=status&operation=deactive&id=".$row['category_id'].
											"'>Active</a></span>&nbsp;";
										}else {
											echo "<span class='badge badge-pending'><a href='?type=status&operation=active&id="
											.$row['category_id'].
											"'>Dective</a></span>&nbsp;";
										}
										echo "<span class='badge badge-edit'><a
										href='manage_categories.php?id="
										.$row['category_id']."'>Edit</a></span>&nbsp;";
										
									    echo "<span class='badge badge-delete'><a href='?type=delete&id="
										.$row['category_id']."'>Delete</a></span>";
