	...
	if ($msg == '') {
		if (isset($_GET['id']) && $_GET['id'] != '') {
			if ($_FILES['image']['name'] != '') {
                ...
                price='$price',qty='$qty',short_description='$short_description',description='$description',best_seller='$best_seller',meta_title='$meta_title',   
					...
					<Form method="post" enctype="multipart/form-data">
						<div class="card-body card-block">
							...
							<div class="form-group">
								...
								<textarea name="short_description" placeholder="Enter product short description" class="form-control" required><?php echo $short_description ?></textarea>
							</div>
							...
							<button name="cancel" class="btn btn-outline-danger w3-myfont px-2 py-2 m-2 float-right shadow-none  waves-effect waves-light" id="cancelslider">Cancel
							</button>
