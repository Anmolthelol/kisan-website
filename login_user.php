                        ...
                        <form id="register-form" method="post">
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    ...
                                    <button type="button" class="fv-btn email_sent_otp height_60px margin-block" onclick="email_sent_otp()">Send OTP</button>

                                    <input type="text" id="email_otp" placeholder="OTP" style="width:45%" class="email_verify_otp">
                                    <button type="button" class="fv-btn email_verify_otp height_60px margin-block " onclick="email_verify_otp()">Verify OTP</button>
